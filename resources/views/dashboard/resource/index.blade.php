...
@section('container')
    ...
    <div>
        <section class="mt-10">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex justify-end items-center d p-4">
                        <div class="flex space-x-3">
                            ...
                            <div class="flex space-x-3 items-center">
                                <label for="truncate_button" class="btn btn-error btn-sm text-white dark:text-gray-800 normal-case bg-red-600 hover:bg-opacity-70 hover:border-opacity-70 dark:bg-red-300 dark:hover:bg-opacity-90" onclick="return truncate_button();">
            ...
            <div class="modal">
                <div class="modal-box">
                    <form action="{{ route('resource.import') }}" method="post" enctype="multipart/form-data">
        ...
        function truncate_button() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "post",
                        url: "{{ route('resource.truncate') }}",
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
                        success: function (response) {
                            Swal.fire({
                                title: 'Data berhasil di truncate!',
                                icon: 'success',
                                confirmButtonColor: '#6419E6',
                                confirmButtonText: 'OK'
                            }).then((result) => {
